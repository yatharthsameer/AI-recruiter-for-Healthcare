...
class ResponseData:
    ...
    audioData: Optional[bytes] = None  # Raw audio data for multimodal analysis
    audioMime: str = "audio/webm"  # Audio MIME type
...
class InterviewSession:
    ...
    def add_user_response(
        ...
        """Add a user response with optional audio data"""
