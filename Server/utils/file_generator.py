...
class FileGenerator:
    ...
    async def save_evaluation_json(self, session_id: str, evaluation_data: Dict) -> str:
        ...
        try:
            ...
            logger.info(f"Saved evaluation JSON: {filename}")
            return str(filepath)

        except Exception as e:
            logger.error(f"Failed to save evaluation JSON: {e}")
            raise
